...
(function($) {
	...
	var EasyGridOptions = {
		...
		// text : "序号",
		// width : 50,
		// isCheck : false, //是否显示checkbox
		// hidden : false, //是否设为隐藏字段
		// format : function(rowjson, index) { //用于格式化输出
		//
		// return index;
		// }
		// },
		...
		// text : "id",
		// width : 50,
		// text_align : "left",//left 、right、center,css中,text_align的可选值
		// isCheck : false,
		// hidden : false
		// }
		]
	 ...
	 */
	$.fn.easygrid = function(EasyGridOption) {
		EasyGridOption = $.extend(EasyGridOptions, EasyGridOption);
		$this = $(this);
